...
The validation catalogue is accessible here: https://vivaplus-validation.readthedocs.io/en/latest/ 
The input files, postprocessing routines and proecessed simulation results are available on the openVT platform: https://openvt.eu/fem/viva/vivaplus-validation 

The following validations have been performed so far:
